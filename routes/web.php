...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('ogretmen-musaitlik/template-advanced', [OgretmenMusaitlikController::class, 'downloadAdvancedTemplate'])->name('ogretmen-musaitlik.template.advanced');
    Route::post('ogretmen-musaitlik/import', [OgretmenMusaitlikController::class, 'import'])->name('ogretmen-musaitlik.import');
    Route::post('ogretmen-musaitlik/import-advanced', [OgretmenMusaitlikController::class, 'importAdvanced'])->name('ogretmen-musaitlik.import.advanced');
