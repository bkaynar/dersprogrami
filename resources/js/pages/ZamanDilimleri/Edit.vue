...
const form = useForm({
  haftanin_gunu: props.zaman_dilimi.haftanin_gunu,
  baslangic_saati: props.zaman_dilimi.baslangic_saati.substring(0, 5),
  bitis_saati: props.zaman_dilimi.bitis_saati.substring(0, 5),
});
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Düzenle',
        href: `/zaman-dilimleri/${props.zaman_dilimi.id}/edit`,
    },
];

const submit = () => {
  form.put(`/zaman-dilimleri/${props.zaman_dilimi.id}`);
};
...
<template>
  <Head :title="`${zaman_dilimi.haftanin_gunu.charAt(0).toUpperCase() + zaman_dilimi.haftanin_gunu.slice(1)} ${zaman_dilimi.baslangic_saati.substring(0, 5)} - Düzenle`" />
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="p-6">
      ...
      <div class="mb-6 flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-semibold">Zaman Dilimi Düzenle</h1>
          <p class="mt-1 text-sm text-muted-foreground">
            {{ zaman_dilimi.haftanin_gunu.charAt(0).toUpperCase() + zaman_dilimi.haftanin_gunu.slice(1) }} - {{ zaman_dilimi.baslangic_saati.substring(0, 5) }} zaman diliminin bilgilerini güncelleyin
          </p>
        </div>
        <Link
          :href="`/zaman-dilimleri/${zaman_dilimi.id}`"
