...
const downloadTemplate = () => {
    window.location.href = '/ogretmenler/template/download';
};

const downloadExcel = () => {
    window.location.href = '/ogretmenler/export';
};
...
const uploadFile = () => {
    ...
    importForm.post('/ogretmenler/import', {
        onSuccess: () => {
            importForm.reset();
            if (fileInput.value) {
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="p-6">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-semibold">Öğretmenler</h1>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button
                        @click="downloadExcel"
                        class="inline-flex items-center gap-2 rounded-lg border bg-background px-4 py-2 text-sm font-medium hover:bg-muted"
                        title="Öğretmenleri Excel olarak indir"
                    >
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <table class="w-full">
                    <thead>
                        <tr class="border-b bg-muted/50">
                            <th class="px-6 py-3 text-left text-sm font-medium">İsim</th>
                            <th class="px-6 py-3 text-left text-sm font-medium">Unvan</th>
