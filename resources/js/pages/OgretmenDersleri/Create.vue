...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Yeni Öğretmen Dersi',
        href: '/ogretmen-dersleri/create',
    },
];

const submit = () => {
  form.post('/ogretmen-dersleri');
};
</script>

<template>
  <Head title="Yeni Öğretmen Dersi" />
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="p-6">
      ...
      <div class="mb-6 flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-semibold">Yeni Öğretmen Dersi Oluştur</h1>
          <p class="mt-1 text-sm text-muted-foreground">
            Bir öğretmene ders atayın
          </p>
        </div>
        <Link
          href="/ogretmen-dersleri"
        ...
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <div class="flex items-center gap-3 pt-4">
            ...
            >
              ...
              {{ form.processing ? 'Oluşturuluyor...' : 'Öğretmen Dersini Oluştur' }}
            </button>
            <Link
              href="/ogretmen-dersleri"
              class="inline-flex items-center gap-2 rounded-lg border bg-card px-4 py-2 text-sm font-medium hover:bg-accent"
