...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
        ...
        href: `/grup-dersleri/${props.grup.id}`,
    },
];
</script>

<template>
    <Head :title="`${grup.isim} - Aldığı Dersler`" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-semibold">{{ grup.isim }}</h1>
                    <p class="mt-1 text-sm text-muted-foreground">
                        {{ grup.yil }}. Yıl - Aldığı Dersler
                    </p>
                </div>
                <Link
                    :href="`/grup-dersleri/${grup.id}/edit`"
            ...
            <div v-else class="flex flex-col items-center justify-center rounded-lg border border-dashed py-12">
                ...
                <h3 class="mt-4 font-semibold">Bu grup henüz hiç ders almıyor</h3>
                <p class="mt-2 text-center text-sm text-muted-foreground">
                    Bu gruba ders eklemek için düzenle butonuna tıklayın
                </p>
                <Link
                    :href="`/grup-dersleri/${grup.id}/edit`"
