...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Yeni Grup Dersi',
        href: '/grup-dersleri/create',
    },
];

const submit = () => {
  form.post('/grup-dersleri');
};
</script>

<template>
  <Head title="Yeni Grup Dersi" />
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="p-6">
      ...
      <div class="mb-6 flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-semibold">Yeni Grup Dersi Oluştur</h1>
          <p class="mt-1 text-sm text-muted-foreground">
            Bir öğrenci grubuna ders atayın
          </p>
        </div>
        <Link
          href="/grup-dersleri"
        ...
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <div class="flex items-center gap-3 pt-4">
            ...
            >
              ...
              {{ form.processing ? 'Oluşturuluyor...' : 'Grup Dersini Oluştur' }}
            </button>
            <Link
              href="/grup-dersleri"
              class="inline-flex items-center gap-2 rounded-lg border bg-card px-4 py-2 text-sm font-medium hover:bg-accent"
