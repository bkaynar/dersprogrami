...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6">
            ...
            <!-- Grup Listesi -->
            <div v-if="gruplar.length > 0" class="overflow-hidden rounded-lg border bg-card">
                <table class="w-full">
                    <thead>
                        <tr class="border-b bg-muted/50">
                            <th class="px-6 py-3 text-left text-sm font-medium">Öğrenci Grubu</th>
                            <th class="px-6 py-3 text-center text-sm font-medium">Aldığı Ders Sayısı</th>
            ...
            <div v-else class="flex flex-col items-center justify-center rounded-lg border border-dashed py-12">
                ...
                <p class="mt-2 text-center text-sm text-muted-foreground">
                    Önce öğrenci grubu eklemeniz gerekiyor
                </p>
                <Link
