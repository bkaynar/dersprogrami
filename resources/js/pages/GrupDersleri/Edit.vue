...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Düzenle',
        href: `/grup-dersleri/${props.grup.id}/edit`,
    },
];
...
const submit = () => {
    form.put(`/grup-dersleri/${props.grup.id}`, {
        preserveScroll: true,
    });
};
</script>
...
<template>
    <Head :title="`${grup.isim} - Dersleri Düzenle`" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6">
            <!-- Header -->
            <div class="mb-6">
                <h1 class="text-2xl font-semibold">{{ grup.isim }} - Dersleri Düzenle</h1>
                <p class="mt-1 text-sm text-muted-foreground">
                    {{ grup.yil }}. Yıl grubunun aldığı dersleri seçin
                </p>
            </div>
