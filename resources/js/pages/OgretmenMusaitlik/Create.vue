...
const form = useForm({
  ogretmen_id: null as number | null,
...
const submit = () => {
  form.post('/ogretmen-musaitlik');
};
</script>

<template>
  <Head title="Yeni Öğretmen Müsaitlik" />
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="p-6">
      ...
      <div class="mb-6 flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-semibold">Yeni Öğretmen Müsaitlik Oluştur</h1>
          <p class="mt-1 text-sm text-muted-foreground">
            Bir öğretmen için müsaitlik durumu tanımlayın
          </p>
        </div>
        <Link
          href="/ogretmen-musaitlik"
        ...
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <div class="flex items-center gap-3 pt-4">
            ...
            >
              ...
              {{ form.processing ? 'Oluşturuluyor...' : 'Müsaitliği Oluştur' }}
            </button>
            <Link
              href="/ogretmen-musaitlik"
              class="inline-flex items-center gap-2 rounded-lg border bg-card px-4 py-2 text-sm font-medium hover:bg-accent"
