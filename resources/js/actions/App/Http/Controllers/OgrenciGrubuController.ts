...
* @see app/Http/Controllers/OgrenciGrubuController.php:96
...
const OgrenciGrubuController = { downloadTemplate, importMethod, index, create, store, show, edit, update, destroy, import: importMethod }
